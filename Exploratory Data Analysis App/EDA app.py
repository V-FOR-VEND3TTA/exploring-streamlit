...
* **Python libraries this app uses:** streamlit, pandas, plotly and numpy
* **For more information, contact: ** [George](george@big-o-media.com).
""")


file_bytes = st.file_uploader("Upload a file (only CSV will can be uploade)", type="csv")
